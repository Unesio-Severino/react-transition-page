...
export default function Home() {
  ...
  return (
    <m.div
      ...
      className=" text-gray-900 absolute top-0 left-0 w-full h-full bg-orange-100 lg:px-20 px-12 "
    >
      <Head>
        <title>React Transition Page</title>
      ...
      <main>
        <div className="my-80 p-1 font-archivo overflow-hidden ">
          <m.h1
            ...
            className="text-5xl text-center lg:text-right lg:text-4xl "
          >
            Happy Pickle
          </m.h1>
        </div>
        <div className="flex justify-between">
          <m.div
            ...
            initial="hidden"
            animate="show"
            className="font-latoBold text-left lg:text-3xl text-2xl"
          >
